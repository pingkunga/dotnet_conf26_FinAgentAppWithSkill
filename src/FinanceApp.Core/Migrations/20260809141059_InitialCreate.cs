    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000101"), true, "Expense", "Groceries", null },
                    { new Guid("00000000-0000-0000-0000-000000000102"), true, "Expense", "Dining", null },
                    { new Guid("00000000-0000-0000-0000-000000000103"), true, "Expense", "Transport", null },
                    { new Guid("00000000-0000-0000-0000-000000000104"), true, "Expense", "Utilities", null },
                    { new Guid("00000000-0000-0000-0000-000000000105"), true, "Expense", "Entertainment", null },
                    { new Guid("00000000-0000-0000-0000-000000000106"), true, "Income", "Income", null },
                    { new Guid("00000000-0000-0000-0000-000000000107"), true, "Expense", "Other", null }
                });
